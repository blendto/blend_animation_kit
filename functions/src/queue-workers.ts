    ...
    try {
      ...
      switch (message.action) {
        ...
        case UserAccountActionType.CREATE_DELETION_PLANS:
          ...
          break;
        case UserAccountActionType.CREATE_DELETION_PLAN_BATCH:
          await projectsFrictionService.createDeletionPlanBatch(
            message.userIds
          );
          break;
        case UserAccountActionType.DELETE_FREE_RESOURCES:
          ...
          break;
        case UserAccountActionType.EXECUTE_DELETION_PLAN_BATCH:
          await projectsFrictionService.executeDeletionPlanBatch(message.plans);
          break;
