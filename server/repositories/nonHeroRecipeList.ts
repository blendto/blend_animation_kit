import { DynamooseEntity, dynamooseModel, DynamooseModel, DynamooseRepo, DynamooseSchema, Entity, Repo } from "./base";
...
interface NonHeroRecipeListDynamooseEntity extends DynamooseEntity, NonHeroRecipeListEntity {
}
        ...
        [{
          ...
          schema: {
            ...
            extra: {
              type: Object,
              schema: {
                title: String, thumbnail: String, isPremium: Boolean,
              },
            },
          },
        }],
...
export class NonHeroRecipeListDynamooseRepo
  extends DynamooseRepo<NonHeroRecipeListEntity, NonHeroRecipeListDynamooseEntity>
